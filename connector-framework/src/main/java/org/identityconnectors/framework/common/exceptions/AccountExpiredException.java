 ...
 * <p/>
 * This exception is thrown by Connector when they determine that an account has
 * expired. For example, a <code>Connector</code>, after successfully
 * authenticating a user, may determine that the user's account has expired. In
 ...
 * @since 1.4
 * @see javax.security.auth.login.AccountExpiredException
 */
public class AccountExpiredException extends InvalidAccountException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new AccountExpiredException exception with <code>null</code>
    ...
    /**
     * Constructs a new AccountExpiredException exception with the specified
