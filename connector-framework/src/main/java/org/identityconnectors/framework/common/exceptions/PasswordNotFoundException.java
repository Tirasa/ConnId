...
/**
 * PasswordNotFoundException signals that a password was not found.
 * <p>
 * This exception may be thrown by a <code>Connector</code> if it is unable to
 * locate a password necessary to perform authentication.
 *
 * @author Laszlo Hordos
 * @since 1.4
 * @see javax.security.auth.login.CredentialNotFoundException
 */
public class PasswordNotFoundException extends InvalidPasswordException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new PasswordNotFoundException exception with
    ...
    /**
     * Constructs a new PasswordNotFoundException exception with the specified
