 ...
 * {@link ScriptOnConnectorOp}, which runs a script in the context of a
 * particular connector.)
 * <p>
 * A connector that intends to support {@link ScriptOnResourceApiOp} should
 ...
 * supported {@link OperationOptions}.
 */
public interface ScriptOnResourceOp extends SPIOperation {

    /**
     * Run the specified script <i>on the target resource</i> that this
     * connector manages.
     *
     * @param request
