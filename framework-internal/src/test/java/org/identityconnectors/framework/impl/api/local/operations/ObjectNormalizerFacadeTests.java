...
public class ObjectNormalizerFacadeTests {
    ...
    public static class MyAttributeNormalizer implements AttributeNormalizer {
        ...
        public Attribute normalizeAttribute(ObjectClass oclass,
                Attribute attribute) {
    ...
    private ObjectNormalizerFacade createTestNormalizer() {
        ObjectNormalizerFacade facade = new ObjectNormalizerFacade(
                ObjectClass.ACCOUNT,
    ...
    public void testAnd() {
        Filter expected =
                FilterBuilder.and(FilterBuilder.contains(
                createNormalizedTestAttribute()),
                FilterBuilder.contains(createNormalizedTestAttribute()));
        Filter filter =
    ...
    public void testOr() {
        Filter expected =
                FilterBuilder.or(FilterBuilder.contains(
                createNormalizedTestAttribute()),
                FilterBuilder.contains(createNormalizedTestAttribute()));
        Filter filter =
    ...
    public void testNot() {
        Filter expected =
                FilterBuilder.not(FilterBuilder.contains(
                createNormalizedTestAttribute()));
        Filter filter =
