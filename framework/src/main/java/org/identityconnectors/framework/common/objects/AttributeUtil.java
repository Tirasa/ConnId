...
public final class AttributeUtil {
     ...
     * @return null if the value is null otherwise the string value for the attribute.
     * @throws ClassCastException iff the object in the attribute is not an string.
     * @throws IllegalArgumentException iff the attribute is a multi-valued (rather than single-valued).
     */
    ...
    /**
     * Get the {@link GuardedString} value from the specified (single-valued) attribute.
     *
     * @param attr Attribute from which to retrieve the string value.
     * @return null if the value is null otherwise the string value for the attribute.
     * @throws ClassCastException iff the object in the attribute is not an GuardedString.
     * @throws IllegalArgumentException iff the attribute is a multi-valued (rather than single-valued).
     */
     ...
     * @return null if the value is null otherwise the integer value for the attribute.
     * @throws ClassCastException iff the object in the attribute is not an integer.
     * @throws IllegalArgumentException iff the attribute is a multi-valued (rather than single-valued).
     */
     ...
     * @throws ClassCastException iff the object in the attribute is not an long.
     * @throws IllegalArgumentException iff the attribute is a multi-valued (rather than single-valued).
     */
     ...
     * @return null if the value is null otherwise the date value for the attribute.
     * @throws ClassCastException iff the object in the attribute is not an long.
     * @throws IllegalArgumentException iff the attribute is a multi-valued (rather than single-valued).
     */
     ...
     * @throws ClassCastException iff the object in the attribute is not an big decimal.
     * @throws IllegalArgumentException iff the attribute is a multi-valued (rather than single-valued).
     */
     ...
     * @throws ClassCastException iff the object in the attribute is not an {@link Boolean}.
     * @throws IllegalArgumentException iff the attribute is a multi-valued (rather than single-valued).
     */
    ...
    /**
     * Get the
     * <code>Object</code> value from the specified (single-valued) attribute. Return
     * <code>null</code> if the attribute's list of values is
    ...
    public static Object getSingleValue(final Attribute attr) {
        ...
        if (val != null && !val.isEmpty()) {
            ...
            if (val.size() > 1) {
                throw new IllegalArgumentException("The method is only for single value attributes.");
            }
            ret = val.get(0);
        }
        return ret;
     ...
     * @throws NullPointerException iff the parameter <strong>attributes</strong> is <strong>null</strong>.
     */
     ...
     * @return null if the set does not contain a {@link Uid} object the first one found.
     */
    ...
    /**
     * Filter out any special attribute from the specified set. Special attributes include {@link Name}, {@link Uid},
     * and {@link OperationalAttributes}.
     *
     * @param attrs set of {@link Attribute}s to filter out the operational and default attributes.
    ...
    /**
     * Filter out any basic attributes from the specified set, leaving only special attributes. Special attributes
     * include {@link Name}, {@link Uid}, and {@link OperationalAttributes}.
     *
     * @param attrs set of {@link Attribute}s to filter out the basic attributes
     * @return a set that only contains special attributes or an empty set if there are none.
     */
    ...
    /**
     * Determines whether the specified attribute is a special attribute. Special attributes include
     * {@link Uid}, {@link ObjectClass} and {@link OperationalAttributes}.
     *
     ...
     * @throws NullPointerException iff the attribute parameter is null.
     */
    ...
    /**
     * Determines whether the specified attribute info is for a special attribute. Special attributes include
     * {@link Uid}, {@link ObjectClass} and {@link OperationalAttributes}.
     *
    ...
    /**
     * Determines whether the specified attribute name is special in the sense of {@link #createSpecialName}.
     *
     ...
     * <code>__</code> string as both prefix and suffix. This indicates that an attribute name identifies a "special
     * attribute" such as {@link Uid},
     * {@link ObjectClass} or one of the {@link OperationalAttributes}.
     */
     ...
     * @return the {@link Name} attribute it if exsist otherwise <code>null</code>.
     */
     ...
     *
     * @param attrs Set of {@link Attribute}s that may contain the current password
     * @return <code>null</code> if it does not exist in the {@link Set} else the value.
     */
    ...
    /**
     * Determine if the {@link ConnectorObject} is locked out. By getting the value of the
     * {@link OperationalAttributes#LOCK_OUT_NAME}.
     *
     * @param obj {@link ConnectorObject} object to inspect.
     * @throws NullPointerException iff the parameter 'obj' is <code>null</code>.
     * @return <code>null</code> if the attribute does not exist otherwise to value of the {@link Attribute}.
     */
    ...
    /**
     * Determine if the {@link ConnectorObject} is enable. By getting the value of the
     * {@link OperationalAttributes#ENABLE_NAME}.
     *
     * @param obj {@link ConnectorObject} object to inspect.
     * @throws IllegalStateException if the object does not contain attribute in question.
     * @throws NullPointerException iff the parameter 'obj' is <code>null</code>.
     * @return <code>null</code> if the attribute does not exist otherwise to value of the {@link Attribute}.
     */
     ...
     * @throws IllegalStateException if the object does not contain attribute in question.
     * @throws NullPointerException iff the parameter 'obj' is <code>null</code>.
     * @return <code>null</code> if the {@link Attribute} does not exist otherwise the value of the {@link Attribute}.
     */
    public static Date getPasswordExpirationDate(final ConnectorObject obj) {
        final Attribute attr = obj.getAttributeByName(OperationalAttributes.PASSWORD_EXPIRATION_DATE_NAME);
        return (attr == null) ? null : new Date(getLongValue(attr));
    }

    /**
     * Get the password expired attribute from a {@link Collection} of {@link Attribute}s.
     *
     * @param attrs set of attribute to find the expired password {@link Attribute}.
     * @return <code>null</code> if the attribute does not exist and the value of the {@link Attribute} if it does.
     */
     ...
     *
     * @param obj {@link ConnectorObject} that should contain a password expired attribute.
     * @return <code>null</code> if the attribute does not exist and the value of the {@link Attribute} if it does.
     */
