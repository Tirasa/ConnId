...
public class ConnectorMessagesImpl implements ConnectorMessages {
    ...
    /**
     * NOTE: We are choosing not to use ResourceBundle here because, for the remote case, we will not be able to use
     * ResourceBundle: rather than have one implementation for C# and one for Java, I have a single implementation
     * for both.
     */
    ...
    private String getFrameworkMessage(Locale locale, String key) {
        ...
        // this will throw if not there, but there should always be at least a bundle
