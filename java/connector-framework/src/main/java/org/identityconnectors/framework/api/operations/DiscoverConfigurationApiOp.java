...
public interface DiscoverConfigurationApiOp extends APIOperation {
     ...
     * It is similar to {@link TestApiOp}, however, it is supposed to be much more forgiving.
     * While the {@link TestApiOp#test()} is supposed to test complete connector configuration,
