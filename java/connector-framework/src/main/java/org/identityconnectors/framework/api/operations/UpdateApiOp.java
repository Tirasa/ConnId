...
/**
 * Updates a {@link ConnectorObject}. This operation is supported for those
 * connectors that implement either {@link UpdateOp} or the more advanced
...
public interface UpdateApiOp extends APIOperation {
     ...
     * {@link UpdateOp} and not {@link UpdateAttributeValuesOp} this method will
     * be simulated by fetching, merging, and calling
     * {@link UpdateOp#update(ObjectClass, Uid, Set, OperationOptions)}.
