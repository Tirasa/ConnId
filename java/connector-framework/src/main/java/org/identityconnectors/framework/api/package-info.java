 ...
 * {@link org.identityconnectors.framework.api.APIConfiguration#getConnectorPoolConfiguration configure connection
 * pooling}.
 * </li>
 *
 ...
 * </p>
 * <p>
 * The application then uses the <code>ConnectorInfo</code> to configure an instance of the connector.
 * The application {@link org.identityconnectors.framework.api.ConnectorInfo#createDefaultAPIConfiguration obtains the
 * default configuration},
 * {@link org.identityconnectors.framework.api.APIConfiguration#getConfigurationProperties lists the available
 * configuration properties}, and then
 * {@link org.identityconnectors.framework.api.ConfigurationProperty#setValue sets values for configuration properties}.
 ...
 * </p>
 * <p>
 * Once the application has an instance of <code>ConnectorFacade</code>, the application can invoke
 ...
 * {@link org.identityconnectors.framework.api.operations.SchemaApiOp#schema describes the object-classes and the
