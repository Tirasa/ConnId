 ...
 * @since 1.4
 */
public final class RetryableException extends ConnectorException {

    private static final long serialVersionUID = -1911392475776488742L;
     ...
     *
     * @param message the detail message (which is saved for later retrieval by the {@link #getMessage()} method).
     * @param cause Exception to wrap or cast and return.
     * @return a <code>RuntimeException</code> that either <i>is</i> the specified exception or <i>contains</i> the
     * specified exception.
     */
    public static RetryableException wrap(String message, Throwable cause) {
        // don't bother to wrap a exception that is already a RetryableException.
        if (cause instanceof RetryableException retryableException) {
    ...
    /**
     * Constructs a new RetryableException which signals partial success of <code>create</code> operation.
     *
     * This should be called inside
     * {@link org.identityconnectors.framework.spi.operations.CreateOp#create}
     ...
     * {@link org.identityconnectors.framework.spi.operations.UpdateOp#update}
     * method now.
     * <p/>
     ...
     * @return a <code>RetryableException</code> that either <i>is</i> the specified exception or <i>contains</i> the
     * specified exception.
     */
    public static RetryableException wrap(final String message, final Uid uid) {
        return new RetryableException(
                message,
                new AlreadyExistsException().initUid(Assertions.nullChecked(uid, "Uid")));
    }
}
