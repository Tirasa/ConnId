...
public final class AttributeBuilder {
     ...
     *
     * @param name unique name of the attribute.
     * @param args variable number of arguments that are used as values for the attribute.
     * @return instance of {@code Attribute} with the specified name and a value that includes the arguments provided.
     */
     ...
     *
     * @param name unique name of the attribute.
     * @param obj a collection of objects that are used as values for the attribute.
     * @return instance of {@code Attribute} with the specified name and a value that includes the arguments provided.
     */
    ...
    /**
     * @return a new attribute with the name and any values that have been provided to the builder.
    ...
    /**
     * Confirm that the attribute that is being built has at most a single value.
     *
     * @throws IllegalArgumentException if the attribute contains more than a single value.
     */
     ...
     * @throws IllegalArgumentException if the attribute contains more than a single value, or if the
    ...
    // =======================================================================
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents the date and time that a
     * password will expire on a target system or application.
     *
     * @param dateTime UTC time in milliseconds.
     * @return an {@code Attribute} with the
     * {@linkplain OperationalAttributes#PASSWORD_EXPIRATION_DATE_NAME pre-defined name for password expiration date}.
     */
    ...
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents the date/time that a
     * password will expire on a target system or application.
     *
     * @param dateTime UTC time in milliseconds.
     * @return an {@code Attribute} with the
    ...
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents the password of an object on
     * a target system or application.
     *
     * @param password the string that represents a password.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#PASSWORD_NAME predefined name
     * for password}.
     */
     ...
     *
     * @param password the characters that represent a password.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#PASSWORD_NAME predefined name
     * for password}.
     */
    ...
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents the current password of an
     * object on a target system or application.
     * <p>
     * Passing the current password indicates the account owner (and not an administrator) is changing the password.
     * The use case is that an administrator password change may not keep history or validate against policy.
     *
     * @param password the string that represents a password.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#PASSWORD_NAME predefined name
    ...
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents the date and time to enable
     * an object on a target system or application.
     * <ul>
     * <li>Use this attribute with {@link CreateApiOp} or
     * {@link org.identityconnectors.framework.api.operations.UpdateApiOp} to set a date and time to enable an object.
     * </li>
     * <li>Read this attribute from {@link org.identityconnectors.framework.api.operations.GetApiOp} to determine when
     * an object will be enabled.</li>
     * <li>Use this attribute with {@link SearchApiOp} to select objects that are scheduled to be enabled at a certain
     * date and time.</li>
     * </ul>
     *
     * @param date The date and time to enable a particular object.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#ENABLE_DATE_NAME predefined name for
     * enable date}.
     */
    ...
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents the date and time to enable
     * an object on a target system or application. The date-and-time parameter is UTC in milliseconds.
     * <ul>
     * <li>Use this attribute with {@link CreateApiOp} or
     * {@link org.identityconnectors.framework.api.operations.UpdateApiOp} to set a date and time to enable an object.
     * </li>
     ...
     * </ul>
     *
     * @param date The date and time (UTC in milliseconds) to enable a particular object.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#ENABLE_DATE_NAME predefined name for
     * enable date}.
     */
    ...
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents the date and time to disable
     * an object on a target system or application.
     * <ul>
     * <li>Use this attribute with {@link CreateApiOp} or
     * {@link org.identityconnectors.framework.api.operations.UpdateApiOp} to set a date and time to disable an object.
     * </li>
     * <li>Read this attribute from {@link org.identityconnectors.framework.api.operations.GetApiOp} to
     * determine when an object will be disabled.</li>
     * <li>Use this attribute with {@link SearchApiOp} to select objects that are scheduled to be disabled at a certain
     * date and time.</li>
     * </ul>
     *
     * @param date The date and time to disable a particular object.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#DISABLE_DATE_NAME predefined name for
     * disable date}.
     */
     ...
     * </ul>
     *
     * @param date The date and time (UTC in milliseconds) to disable a particular object.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#DISABLE_DATE_NAME predefined name for
     * disable date}.
     */
    ...
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents whether an object is locked
     * out on a target system or application.
     * <ul>
     * <li>Read this attribute from
     * {@link org.identityconnectors.framework.api.operations.GetApiOp} to determine whether an object is currently
     * locked out.</li>
     * <li>Use this attribute with {@link org.identityconnectors.framework.api.operations.UpdateApiOp} to
     * clear the lock-out status of an object (or to set the lock-out status of an object).</li>
     * <li>Use this attribute with {@link SearchApiOp} to select objects that are currently locked out (or to select
     * objects that are not currently locked out).</li>
     * </ul>
     *
     * @param lock true if the object is locked out; otherwise false.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#LOCK_OUT_NAME predefined name for
     * lockout state}.
     */
    ...
    /**
     * Builds an {@linkplain OperationalAttributes operational attribute} that represents whether the password of an
     * object is expired on a target system or application.
     * <ul>
     * <li>Read this attribute from {@link org.identityconnectors.framework.api.operations.GetApiOp} to
     * determine whether the password of an object is currently expired.</li>
     * <li>Use this attribute with {@link org.identityconnectors.framework.api.operations.UpdateApiOp} to
     * expire the password of an object (or to clear the expired status of the password of an object).</li>
     * <li>Use this attribute with {@link SearchApiOp} to select objects that have passwords that are currently expired
     * (or to select objects that have passwords that are not currently expired).</li>
     * </ul>
     *
     * @param value from the API true expires and from the SPI its shows its either expired or not.
     * @return an {@code Attribute} with the {@linkplain OperationalAttributes#PASSWORD_EXPIRED_NAME predefined name
     * for password expiration state}.
     */
    ...
    // =======================================================================
    /**
     * Builds an {@linkplain PredefinedAttributes pre-defined attribute} that represents the date and time of the most
     * recent login for an object (such as an account) on a target system or application.
     *
     * @param date The date and time of the last login.
     * @return an {@code Attribute} with the {@linkplain PredefinedAttributes#LAST_LOGIN_DATE_NAME predefined name for
     * password expiration state}.
     */
     ...
     *
     * @param date The date and time (UTC in milliseconds) of the last login.
     * @return an {@code Attribute} with the {@linkplain PredefinedAttributes#LAST_LOGIN_DATE_NAME predefined name for
     * password expiration state}.
     */
    ...
    /**
     * Builds an {@linkplain PredefinedAttributes pre-defined attribute} that represents the date and time that the
     * password was most recently changed for an object (such as an account) on a target system or application.
     *
     * @param date The date and time that the password was most recently changed.
     * @return an {@code Attribute} with the {@linkplain PredefinedAttributes#LAST_PASSWORD_CHANGE_DATE_NAME predefined
    ...
    /**
     * Builds an {@linkplain PredefinedAttributes pre-defined attribute} that represents how often the password must be
     * changed for an object (such as an account) on a target system or application.
     * <p>
     * The value for this attribute is expressed in milliseconds.
     *
     * @param value The number of milliseconds between the time that the password was most recently changed and the
     * time when the password must be changed again.
     * @return an {@code Attribute} with the {@linkplain PredefinedAttributes#PASSWORD_CHANGE_INTERVAL_NAME predefined
     * name for password expiration state}.
     */
