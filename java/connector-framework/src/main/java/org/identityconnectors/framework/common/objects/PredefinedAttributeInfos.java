...
public final class PredefinedAttributeInfos {
    ...
    private PredefinedAttributeInfos() {
    }
     ...
     * an object.
     *
     * If this is not present, then the application will have to use the NAME to
     * show the value.
     */
    public static final AttributeInfo SHORT_NAME = AttributeInfoBuilder
     ...
     * is available.
     */
    public static final AttributeInfo DESCRIPTION = AttributeInfoBuilder
     ...
     * changed.
     */
    public static final AttributeInfo LAST_PASSWORD_CHANGE_DATE = AttributeInfoBuilder.build(
     ...
     * so often.
     *
     * The value for this attribute is milliseconds since its the lowest common
     * denominator.
     */
    public static final AttributeInfo PASSWORD_CHANGE_INTERVAL = AttributeInfoBuilder.build(
     ...
     * inactivity.
     */
    public static final AttributeInfo LAST_LOGIN_DATE = AttributeInfoBuilder.build(
            PredefinedAttributes.LAST_LOGIN_DATE_NAME, long.class, EnumSet.of(Flags.NOT_CREATABLE,
                    Flags.NOT_UPDATEABLE));

    /**
     * Groups that an account belongs to. The Attribute values are the UID value
     * of each group that an account has membership in.
     */
