...
/**
 * Defines standard syntax and semantics for common attributes that are not
 * {@linkplain OperationalAttributes operational in nature}.
 */
public final class PredefinedAttributes {
     ...
     *
     * If {@code SHORT_NAME} is not present, then the application should use the
     * value of {@link Name the NAME attribute} as a label.
     */
    ...
    /**
     * Attribute that refers to groups to which an {@linkplain ConnectorObject
     * object} (usually an {@linkplain ObjectClass#ACCOUNT account}) belongs.
     *
     * This {@code "GROUPS"} attribute is intended for
     * {@link ObjectClass#ACCOUNT}, but another object-class that can be a
     * member of a group could support this attribute.
     * <p>
     * Each (element within the) value of this attribute is the string value of
     * a Uid. Each Uid identifies an instance of {@link ObjectClass#GROUP}.
     */
     ...
     */
    public static final String AUXILIARY_OBJECT_CLASS_NAME = createSpecialName("AUXILIARY_OBJECT_CLASS");
}
