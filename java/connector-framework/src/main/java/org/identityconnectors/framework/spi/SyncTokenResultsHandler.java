...
public interface SyncTokenResultsHandler extends SyncResultsHandler {
     ...
     *
     * @param result The sync result indicating that no more resources are to be returned and, if applicable, including
     * information which should be used for next sync requests.
     */
