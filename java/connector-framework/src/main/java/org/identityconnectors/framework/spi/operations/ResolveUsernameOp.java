...
public interface ResolveUsernameOp extends SPIOperation {
     ...
     * {@link Uid} corresponding to the username. Implementations method must,
     ...
     * {@link RuntimeException} either {@link IllegalArgumentException} or if a
     * native exception is available and if its of type {@link RuntimeException}
     * simple throw it. If the native exception is not a
     * {@link RuntimeException} wrap it in one and throw it. This will provide
