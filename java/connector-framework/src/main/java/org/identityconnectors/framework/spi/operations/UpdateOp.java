 ...
 * {@link UpdateAttributeValuesOp} interface if the Connector will allow an
 ...
 * UpdateAttributeValuesOp}, which must handle any of several different types of
 * update that the caller may specify. However a true implementation of {link
 * UpdateAttributeValuesOp} offers better performance and atomicity semantics.
 *
 * @author Will Droste
 * @since 1.0
 */
